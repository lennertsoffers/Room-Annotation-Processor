package be.lennertsoffers.demo_custom_annotation_processor.fragments;
...
import be.lennertsoffers.demo_custom_annotation_processor.MainActivity;
import be.lennertsoffers.demo_custom_annotation_processor.PersonRepository;
import be.lennertsoffers.demo_custom_annotation_processor.R;
import be.lennertsoffers.demo_custom_annotation_processor.adapters.PersonsAdapter;
import be.lennertsoffers.demo_custom_annotation_processor.models.Person;
...
public class PersonsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        PersonRepository personRepository = MainActivity.db.getPersonRepository();
        ...
        this.personsAdapter = new PersonsAdapter(personRepository.findAll());
        ...
        savePersonButton.setOnClickListener((v) -> {
            ...
            person.setName(name);
            person.setAge(age);
            long personId = personRepository.insert(person);
