...
import be.lennertsoffers.demo_custom_annotation_processor.CarRepository;
...
import be.lennertsoffers.demo_custom_annotation_processor.adapters.CarsAdapter;
...
public class CarsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CarRepository carRepository = MainActivity.db.getCarRepository();
        ...
        this.carsAdapter = new CarsAdapter(carRepository.findAll());
        ...
        saveCarButton.setOnClickListener((v) -> {
            ...
            car.setModel(model);
            car.setPrice(price);
            long carId = carRepository.insert(car);
            car.setId((int) carId);
